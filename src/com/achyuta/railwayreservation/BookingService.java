...
public class BookingService {
    ...
    public BookingService(){
        trainList.add(new Train(101,"Rajadhani Express","Delhi","Nagpur",100));
        trainList.add(new Train(102,"Bangiripushi Superfast Express","Bangiripushi","Puri",556));
        trainList.add(new Train(103,"Dhauli express ","Puri","Kolkata",230));
        trainList.add(new Train(104,"Balasore-Puri Memu","Balasore","Puri",450));
        trainList.add(new Train(105,"Puri-Intersity Memu","Baripada","Puri",890));
    ...
    public  boolean cancelTicket(int ticketId,User user)
    {
        ...
        while (iterator.hasNext()){
            ...
            ticket.getUser().getUsername().equalsIgnoreCase(user.getUsername())){
                ...
                iterator.remove();
                System.out.println("Ticket"+ticketId+"cancelled Successsfully");
                return true;
            }
        }
